...
mod tests {
    ...
    fn build_model<B: Backend>(device: &burn::tensor::Device<B>) -> DinoVisionTransformer<B> {
    ...
    fn dino_initializes_ndarray() {
        let device = burn::tensor::Device::<NdArrayBackend>::default();
    ...
    fn dino_runs_inference_ndarray() {
        ...
        assert_eq!(output.x_norm_patchtokens.dims()[2], embed_dim);
    }
